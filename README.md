...
--JavaScript Estructurado y Modular: Creación de un catálogo de datos local propio (Array de objetos) para gestionar de forma centralizada la información, imágenes y precios de los productos de impresión 3D.
--Manipulación Dinámica del DOM: Renderizado automatizado en pantalla de las tarjetas de los productos recorriendo la lista local.
--Persistencia de Datos y Eventos: Sistema interactivo de carrito de compras que lee, añade cantidades y guarda el estado del usuario entre sesiones de navegación, además de recordar los datos del formulario de contacto.
